...
public class AdapterCouponHetHan extends RecyclerView.Adapter<AdapterCouponHetHan.CouponViewHolder> {

    private static final String TAG = "AdapterCouponHetHan";
    ...
    public AdapterCouponHetHan(Context context, List<CouponRequestModel> couponList) {
    ...
    public CouponViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_coupon_expired, parent, false); // Use the new layout for expired coupons
